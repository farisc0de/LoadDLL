    Public Function LoadDLL(ByVal PluginBytes As Byte(), ByVal className As String, ByVal methodName As String, Optional ByVal hasParameters As Boolean = False, Optional ByVal parameters As Dictionary(Of Object, Object) = Nothing) As Object
